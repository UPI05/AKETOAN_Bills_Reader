...
pdfExtract.extract("./pdfs/10.pdf", options, (err, data) => {
  ...
  // for (let i = 0; i < randomData.length; i++) randomData[i].y = Math.floor(randomData[i].y);
  ...
  */
  ...
  for (let i = 0; i < header.length; i++) {
    ...
    if (standardedStr.match("mauso")) {
      console.log(`Mau so: ${getDataAfterColon(str)}`);
    }
    if (standardedStr.match("kyhieu")) {
      console.log(`Ky hieu: ${getDataAfterColon(str)}`);
    }
    if (standardedStr.match("so:") || standardedStr.match(/so\(/)) {
      console.log(`So: ${getDataAfterColon(str)}`);
    }
    ...
    if (standardedStr.match("diachi:") || standardedStr.match(/diachi\(/)) {
      if (address1Found) {
        console.log(`Dia chi don vi mua: ${getDataAfterColon(str)}`);
      } else {
        console.log(`Dia chi don vi ban: ${getDataAfterColon(str)}`);
        address1Found = true;
      }
    }
    if (standardedStr.match("masothue:") || standardedStr.match(/masothue\(/)) {
      if (taxId1Found) {
        console.log(`Ma so thue don vi mua: ${getDataAfterColon(str)}`);
      } else {
        console.log(`Ma so thue don vi ban: ${getDataAfterColon(str)}`);
        taxId1Found = true;
      }
    }
    if (standardedStr.match("ngay")) {
      console.log(`Ngay: ${getDataBeginWith(str, "Ngày")}`);
    }
    if (standardedStr.match("nguoimua")) {
      console.log(`Nguoi mua: ${getDataAfterColon(str)}`);
    }
    if (
      ...
      if (companyFound) {
        console.log(`Don vi mua: ${dt}`);
      } else {
        console.log(`Don vi ban: ${dt}`);
        companyFound = true;
      }
    }
  }
